  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="goods in order.detailArrayList"
          :key="goods.skuId"
        >
          <li>
            <img
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ selectedManInfo.userAddress }}</span>
        收货人：<span>{{ selectedManInfo.consignee }}</span>
        <span>{{ selectedManInfo.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapState("trade", ["addressList", "order"]),
    selectedManInfo() {
  ...
  methods: {
    ...
    async submitOrder() {
      let data = {
        consignee: this.selectedManInfo.consignee,
        consigneeTel: this.selectedManInfo.phoneNum,
        deliveryAddress: this.selectedManInfo.userAddress,
        paymentWay: "ONLINE",
      ...
      try {
        let result = await this.$API.reqSubmitOrder(this.order.tradeNo, data);
