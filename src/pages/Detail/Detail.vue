          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd
                  ...
                  :key="attrValue.id"
                  @click="chooseAttrValue(index,attr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="substractSkuNum"
                  >-</a
                >
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    ...
    async addShopCart(){
      ...
      let result = await this.$store.dispatch('addcartsuccess/addOrUpdateCart',{skuId:this.$route.params.skuId, skuNum:this.skuNum});
      //前端需要知道是否添加成功，来决定是否跳转路由
      if(result =='ok'){
        this.$router.push({
          path:'/addcartsuccess',
